    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('🔰 Join in Our Channel 🔰', url=f'{TUTORIAL}')
                    ]
                    ]
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
                InlineKeyboardButton("💠 Channel", url=f'https://t.me/SSOTTNEW'),
                InlineKeyboardButton("♻️ Group", url=f'https://t.me/NetflixMovies_sslinkz')
                ]]
            )
        )
        StopPropagation
